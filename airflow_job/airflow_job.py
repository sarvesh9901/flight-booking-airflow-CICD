...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="my_airflow_projects")
    bq_project = Variable.get("bq_project", default_var="turnkey-channel-358109")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"my_airflow_projects/my_airflow_project_03/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/my_airflow_project_03/spark-job/spark_transformation_job.py",  # Main Python file
